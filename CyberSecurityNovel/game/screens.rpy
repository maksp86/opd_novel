...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("О новелле") action ShowMenu("about")
...
screen about():
    ...
    use game_menu(_("О новелле"), scroll="viewport"):
        ...
        vbox:
            ...
            label "Автор: "
            text _("{a=https://github.com/maksp86}Петухов Максим{/a} (РИ-131002/РИ-231002)")

            text _("\n\nНовелла создана с помощью {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].")
            text _("\n\n[renpy.license!t]\n\nЗвуки и изображения, содержащиеся в данном программном продукте, не созданные автором, использованы на основе добросовестного использования (fair use) и содержат ссылку на источник.")
