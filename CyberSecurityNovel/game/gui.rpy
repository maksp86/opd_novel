...
define gui.text_font = "gui/fonts/NunitoSans_10pt-Regular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "gui/fonts/NunitoSans_10pt-SemiBold.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "gui/fonts/pixelcyr_normal.ttf"
